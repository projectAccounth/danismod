...
public class LionModel extends EntityModel<LionRenderState> {
	...
	public static TexturedModelData getStandingModel() {
		...
		ModelPartData root = modelPartData.addChild("root", ModelPartBuilder.create().uv(0, 0).cuboid(-5.0F, -5.0F, -12.0F, 10.0F, 10.0F, 24.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 9.0F, -1.0F));

		ModelPartData legs = root.addChild("legs", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 9.0F, 1.0F));

		ModelPartData leg1bone = legs.addChild("leg1bone", ModelPartBuilder.create().uv(38, 66).cuboid(-2.0F, 0.0F, -2.0F, 4.0F, 10.0F, 4.0F, new Dilation(0.0F)), ModelTransform.origin(3.0F, -4.0F, -10.0F));

		ModelPartData leg2bone = legs.addChild("leg2bone", ModelPartBuilder.create().uv(54, 66).cuboid(-2.0F, 0.0F, -2.0F, 4.0F, 10.0F, 4.0F, new Dilation(0.0F)), ModelTransform.origin(-3.0F, -4.0F, -10.0F));

		ModelPartData leg3bone = legs.addChild("leg3bone", ModelPartBuilder.create().uv(22, 54).cuboid(-2.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F)), ModelTransform.origin(3.25F, -4.0F, 11.0F));

		ModelPartData leg4bone = legs.addChild("leg4bone", ModelPartBuilder.create().uv(0, 66).cuboid(-2.0F, -2.25F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F)), ModelTransform.origin(-3.25F, -3.75F, 11.0F));

		ModelPartData headbone = root.addChild("headbone", ModelPartBuilder.create().uv(40, 52).cuboid(-4.0F, -3.5F, -7.25F, 8.0F, 7.0F, 7.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, -2.5F, -11.75F));

		ModelPartData snoutbone = headbone.addChild("snoutbone", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 1.3229F, -7.3461F));
		...
		ModelPartData ears = headbone.addChild("ears", ModelPartBuilder.create(), ModelTransform.origin(-3.5F, -2.0F, -3.75F));

		ModelPartData ear1bone = ears.addChild("ear1bone", ModelPartBuilder.create(), ModelTransform.origin(7.2145F, -1.1651F, 0.0F));
		...
		ModelPartData ear2bone = ears.addChild("ear2bone", ModelPartBuilder.create(), ModelTransform.origin(-0.3145F, -1.1651F, 0.0F));
		...
		ModelPartData manebone = headbone.addChild("manebone", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 1.333F, -0.551F));
		...
		.uv(61, 44).cuboid(-1.0F, -1.0F, 13.0F, 2.0F, 2.0F, 3.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, -2.0F, 12.0F));
	...
	public static TexturedModelData getLyingModel() {
		ModelData modelData = new ModelData();
		ModelPartData modelPartData = modelData.getRoot();
		ModelPartData root = modelPartData.addChild("root", ModelPartBuilder.create().uv(0, 0).cuboid(-5.0F, -5.0F, -12.0F, 10.0F, 10.0F, 24.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 17.25F, -1.0F));
