...
import org.danismod.danismod.client.mob_renderers.render_states.BuffaloRenderState;
...
public class BuffaloModel extends EntityModel<BuffaloRenderState> {
	...
	public BuffaloModel(ModelPart root) {
		...
		this.limb_front_left = this.legs.getChild("limb_front_left");
		this.limb_back_right = this.legs.getChild("limb_back_right");
		this.limb_back_left = this.legs.getChild("limb_back_left");
		this.limb_front_right = this.legs.getChild("limb_front_right");
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData limb_front_left = legs.addChild("limb_front_left", ModelPartBuilder.create().uv(2, 112).cuboid(-2.5F, -1.0F, -1.0F, 5.0F, 14.0F, 6.0F, new Dilation(0.0F)), ModelTransform.pivot(10.0F, -13.0F, 0.0F));

		ModelPartData limb_back_right = legs.addChild("limb_back_right", ModelPartBuilder.create().uv(76, 77).cuboid(-2.8F, -0.25F, -3.5F, 5.0F, 13.0F, 7.0F, new Dilation(0.0F)), ModelTransform.pivot(0.75F, -12.75F, 26.5F));

		ModelPartData limb_back_left = legs.addChild("limb_back_left", ModelPartBuilder.create().uv(43, 108).cuboid(-2.45F, 0.0F, -3.5F, 5.0F, 13.0F, 7.0F, new Dilation(0.0F)), ModelTransform.pivot(9.0F, -13.0F, 26.5F));

		ModelPartData limb_front_right = legs.addChild("limb_front_right", ModelPartBuilder.create().uv(78, 0).cuboid(-2.5F, -0.75F, -3.0F, 5.0F, 14.0F, 6.0F, new Dilation(0.0F)), ModelTransform.pivot(-0.5F, -13.25F, 2.0F));
