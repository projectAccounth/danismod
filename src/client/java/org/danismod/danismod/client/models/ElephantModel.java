...
public class ElephantModel extends EntityModel<ElephantRenderState> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData torso = root.addChild("torso", ModelPartBuilder.create().uv(8, 0).cuboid(-20.6F, 0.0F, -16.7F, 21.8F, 19.0F, 36.7F, new Dilation(0.0F))
                .uv(150, 17).cuboid(-17.6F, -2.8F, -16.7F, 16.0F, 2.8F, 36.7F, new Dilation(0.0F)), ModelTransform.origin(10.6F, -12.0F, -4.0F));

        ModelPartData head = root.addChild("head", ModelPartBuilder.create().uv(89, 11).cuboid(-5.7518F, -7.2397F, 0.2797F, 11.5518F, 14.4397F, 11.5518F, new Dilation(0.0F)), ModelTransform.origin(0.7F, -9.4828F, 16.0203F));

        ModelPartData ears = head.addChild("ears", ModelPartBuilder.create(), ModelTransform.origin(-0.1F, 1.5F, 1.4F));

        ModelPartData earRight = ears.addChild("earRight", ModelPartBuilder.create().uv(37, 56).cuboid(16.6F, -10.1276F, -5.7203F, 13.973F, 17.3276F, 1.0397F, new Dilation(0.0F)), ModelTransform.origin(-11.0F, 0.0F, 7.0F));

        ModelPartData earLeft = ears.addChild("earLeft", ModelPartBuilder.create().uv(6, 56).cuboid(-8.173F, -10.1276F, -5.7203F, 13.973F, 17.3276F, 1.0397F, new Dilation(0.0F)), ModelTransform.origin(-11.0F, 0.0F, 7.0F));
        ...
        ModelPartData trunk = head.addChild("trunk", ModelPartBuilder.create().uv(124, 7).cuboid(0.9698F, 10.3921F, -2.1203F, 3.6802F, 12.2079F, 4.0891F, new Dilation(0.0F))
                ...
                .uv(126, 38).cuboid(-0.0875F, -11.8572F, -3.3203F, 5.7875F, 12.0572F, 6.4305F, new Dilation(0.0F)), ModelTransform.origin(-2.7F, 9.8F, 13.2F));

        ModelPartData tusks = head.addChild("tusks", ModelPartBuilder.create(), ModelTransform.origin(-0.1891F, 6.2484F, 10.878F));

        ModelPartData tuskLeft = tusks.addChild("tuskLeft", ModelPartBuilder.create(), ModelTransform.origin(-3.4218F, 0.0F, 0.0F));
        ...
        ModelPartData tuskRight = tusks.addChild("tuskRight", ModelPartBuilder.create(), ModelTransform.origin(4.0F, 0.0F, 0.0F));
        ...
        ModelPartData legs = root.addChild("legs", ModelPartBuilder.create(), ModelTransform.origin(1.0875F, 6.0384F, -2.8417F));

        ModelPartData frontleft = legs.addChild("frontleft", ModelPartBuilder.create().uv(14, 0).cuboid(-3.8725F, 0.766F, -3.8583F, 7.425F, 19.9233F, 7.7166F, new Dilation(0.0F)), ModelTransform.origin(-6.3F, 0.0F, 14.0F));

        ModelPartData backright = legs.addChild("backright", ModelPartBuilder.create().uv(14, 0).cuboid(-3.8725F, 0.766F, -3.8583F, 7.425F, 19.9233F, 7.7166F, new Dilation(0.0F)), ModelTransform.origin(7.0F, 0.0F, -13.0F));

        ModelPartData frontright = legs.addChild("frontright", ModelPartBuilder.create().uv(14, 0).cuboid(8.4275F, 0.766F, -3.8583F, 7.425F, 19.9233F, 7.7166F, new Dilation(0.0F)), ModelTransform.origin(-6.3F, 0.0F, 14.0F));

        ModelPartData backleft = legs.addChild("backleft", ModelPartBuilder.create().uv(14, 0).cuboid(-5.1725F, 2.766F, -3.8583F, 7.425F, 19.9233F, 7.7166F, new Dilation(0.0F)), ModelTransform.origin(-5.0F, -2.0F, -13.0F));
        ...
        ModelPartData tail = root.addChild("tail", ModelPartBuilder.create().uv(118, 65).cuboid(-1.1334F, -1.127F, -13.5477F, 2.2334F, 2.3049F, 3.7681F, new Dilation(0.0F))
                .uv(102, 44).cuboid(-0.6138F, -0.6779F, -9.7477F, 1.3138F, 1.3558F, 9.8953F, new Dilation(0.0F)), ModelTransform.origin(0.8F, -6.5779F, -20.5524F));
