...
public class BuffaloModel extends EntityModel<BuffaloRenderState> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData root = modelPartData.addChild("root", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 2.25F, 3.25F));

		ModelPartData legs = root.addChild("legs", ModelPartBuilder.create(), ModelTransform.origin(-4.75F, 21.75F, -13.25F));

		ModelPartData front_left = legs.addChild("front_left", ModelPartBuilder.create().uv(2, 112).cuboid(-2.5F, -1.0F, -1.0F, 5.0F, 14.0F, 6.0F, new Dilation(0.0F)), ModelTransform.origin(10.0F, -13.0F, 0.0F));

		ModelPartData back_right = legs.addChild("back_right", ModelPartBuilder.create().uv(76, 77).cuboid(-2.8F, -0.25F, -3.5F, 5.0F, 13.0F, 7.0F, new Dilation(0.0F)), ModelTransform.origin(0.75F, -12.75F, 26.5F));

		ModelPartData back_left = legs.addChild("back_left", ModelPartBuilder.create().uv(43, 108).cuboid(-2.45F, 0.0F, -3.5F, 5.0F, 13.0F, 7.0F, new Dilation(0.0F)), ModelTransform.origin(9.0F, -13.0F, 26.5F));

		ModelPartData front_right = legs.addChild("front_right", ModelPartBuilder.create().uv(78, 0).cuboid(-2.5F, -0.75F, -3.0F, 5.0F, 14.0F, 6.0F, new Dilation(0.0F)), ModelTransform.origin(-0.5F, -13.25F, 2.0F));
		...
		.uv(4, 36).cuboid(-1.0F, -15.0F, -12.0F, 14.0F, 17.0F, 16.0F, new Dilation(0.0F)), ModelTransform.origin(-6.0F, 6.75F, 11.75F));
		...
		.uv(40, 69).cuboid(-1.0F, -1.0F, 13.25F, 2.0F, 2.0F, 4.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, -5.75F, 15.5F));

		ModelPartData head = root.addChild("head", ModelPartBuilder.create(), ModelTransform.origin(0.0F, -5.25F, -19.0F));

		ModelPartData horns = head.addChild("horns", ModelPartBuilder.create(), ModelTransform.origin(-8.924F, -1.4266F, -1.9128F));

		ModelPartData horn_left = horns.addChild("horn_left", ModelPartBuilder.create(), ModelTransform.origin(17.8481F, 0.0F, 0.0F));
		...
		ModelPartData horn_right = horns.addChild("horn_right", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0F, 0.0F));
		...
		ModelPartData headpart = head.addChild("headpart", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 2.4235F, -3.024F));
